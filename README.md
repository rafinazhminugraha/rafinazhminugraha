...
| [Gamicus](https://github.com/rafinazhminugraha/game-hub.git) | Game discovery app — infinite scroll, debounced search, Zod-validated API responses, full unit test coverage | React, TanStack Query, Zustand, Zod, Vitest | [↗](https://gamicus-nazhmi.vercel.app) |
| [Pomoductive](https://github.com/rafinazhminugraha/Pomoductive.git) | Pomodoro timer for deep work — 4 session templates, ADHD-friendly audio, dynamic focus/break theming | Next.js, TypeScript, Tailwind, Web Audio API | [↗](https://pomoductive-rafi-nazhmi-nugraha.vercel.app/) |
